...
<button class="btn btn-primary" type="submit" name="submit">Add</button>
    ...
    <?php
        ...
        move_uploaded_file($filename,  $destFile);
            ...
            $sql = "INSERT INTO tv(brand,name,des,stock,price,img_name)
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Sony</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <thead>
    <tr>
     ...
     <?php
      include_once("connection.php");
      $count = 0;
      $rom="SELECT * FROM tv WHERE brand='Sony'";
  ...
  <thead>
    <tr>
     ...
     <?php
      include_once("connection.php");
      $count = 0;
      $rom="SELECT * FROM tv WHERE brand='Samsung'";
      $rim = mysqli_query($conn,$rom);
...
<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Lg</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
